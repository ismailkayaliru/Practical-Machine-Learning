...
The labelled dataset was downloaded on September 22nd, 2015 and loaded into R.
...
There were a total of r nrow(training) observations in the training set and r nrow(testing) in the testing set. The unlabelled validation dataset was also downloaded.
